        ...
        o.submit(function() {
          ...
          return (
            ...
            o.valid()
              ? ($.ajax({
                  type: 'POST',
                  url: 'https://jp71d9ofs0.execute-api.ap-south-1.amazonaws.com/dev/contact',
                  ...
                  success: function(t) {
                    ...
                    (a =
                      'OK' === t
                        ? '<div class="alert alert-success">Done! Thanks for your message - I will get back to you as fast as possible!'
