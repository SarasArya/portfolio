            ...
            o.validate({
                ...
                return e.hide().html(), o.valid() ? ($.ajax({
                    ...
                    success: function(t) {
                        console.log(t);
                        a = "OK";
                        a === t ? '<div class="alert alert-success">Done! Thank for your message - I will get back to you as fast as possible!' : '<div class="alert alert-danger">Ooops... It seems that we have a problem.' e.html(a), e.show()
                    }
                }), !1) : !1
            })
        }
